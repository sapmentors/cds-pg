...
CREATE VIEW BeershopService_Beers
AS
  SELECT
    Beers_0.ID,
    Beers_0.name,
...
CREATE VIEW BeershopService_Breweries
AS
  SELECT
    Brewery_0.ID,
    Brewery_0.name,
...
CREATE VIEW BeershopService_TypeChecks
AS
  SELECT
    TypeChecks_0.ID,
...
COPY csw_Brewery
(ID, name) FROM '/tmp/data/csw-Brewery.csv' DELIMITER ',' CSV HEADER;
...
CREATE VIEW superbeer.BeershopService_Beers
AS
  SELECT
    Beers_0.ID,
    Beers_0.name,
